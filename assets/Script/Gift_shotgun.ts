...
@ccclass
export default class Gift_shotgun extends cc.Component {
    ...
    update(){
        if(this.animateState == null || this.animateState.name != 'Shotgun'  ){
            this.animateState = this.anim.play('Shotgun');
        }
    }
